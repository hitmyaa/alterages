  ...
  return (
    <article className="container max-w-3xl py-16 md:py-24">
      ...
      <p className="mt-6 text-lg text-muted-foreground">
        Un formulaire de contact sera disponible ici prochainement. En attendant, vous
        pouvez nous écrire à{' '}
        <a href="mailto:contact@alterages.fr" className="font-medium text-primary underline-offset-4 hover:underline">
