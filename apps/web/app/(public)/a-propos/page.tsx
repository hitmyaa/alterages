  ...
  return (
    <article className="container max-w-3xl py-16 md:py-24">
      ...
      <p className="text-muted-foreground mt-6 text-lg">
        Alterages est une plateforme d'accompagnement pensée pour fluidifier la collaboration entre
        les personnes aidées, leurs proches et les intervenants professionnels qui les soutiennent
        au quotidien.
      </p>

      <section id="beneficiaires" className="mt-12 space-y-3">
        <h2 className="text-2xl font-semibold">Pour les bénéficiaires</h2>
        <p className="text-muted-foreground">Cette page est en cours de rédaction.</p>
      </section>
